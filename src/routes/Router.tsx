...
import NewSales from 'src/pages/NewSales.tsx';
import NewPurchase from 'src/pages/NewPurchase.tsx';
import Inventory from 'src/pages/Inventory.tsx';
import AddInventory from 'src/pages/AddInventory.tsx';
/* ***Layouts**** */
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/addSales', exact: true, element: <NewSales /> },
      { path: '/addPurchase', exact: true, element: <NewPurchase /> },
      { path: '/inventory', exact: true, element: <Inventory /> },
      { path: '/addInventory', exact: true, element: <AddInventory /> },
