            ...
            <div className="overflow-x-auto">
              <Table>
                <Table.Head className="border-b border-bordergray dark:border-darkborder">
                  ...
                  <Table.HeadCell className="text-ld font-normal">Priority</Table.HeadCell>
                  <Table.HeadCell className="text-ld font-normal">Budget</Table.HeadCell>
                </Table.Head>
                <Table.Body className="divide-y divide-bordergray dark:divide-darkborder ">
                  {ProductTableData.map((item, index) => (
                    <Table.Row key={index}>
                      ...
                      <Table.Cell className="whitespace-nowrap ">
                        <Badge color={item.statuscolor} className={`${item.statustextcolor}`}>
                          {item.statustext}
                        </Badge>
                      </Table.Cell>
                      <Table.Cell className="whitespace-nowrap ">
