...
import { Table, TextInput, Button, Datepicker, Label, Select } from 'flowbite-react';
...
const NewSales: React.FC = () => {
  ...
  return (
    <div className="p-4 space-y-6">
      <h1 className="text-2xl font-semibold text-gray-800 dark:text-white">Add New Sale</h1>
